...
#
# Usage:
#   source("multivar_common.r")
#   source("msar_likelihood.r")
#   source("spatial_utilities.r")
#   source("model_methods.r")
#   source("initial_estimation_extended.r")
#   source("msem_mgns_likelihood.r")
#   source("penalized_spatial.r")       # <- this file
#   source("build_result_object.r")     # unified output-structure helper
...
# 1b. Hessian and effective-degrees-of-freedom computation for GIC
#
...
compute_profile_hessian_msar <- function(
  ...
  neg_profile_loglik <- function(param) {
    ...
    # check_stationarity is intentionally not used here; a smooth objective improves Hessian accuracy
...
compute_profile_hessian_mgns <- function(
  ...
  neg_profile_loglik <- function(param) {
    ...
    # a smooth objective (no check_stationarity) improves Hessian accuracy
...
compare_gamma_twostage <- function(
  ...
  build_fine_grid <- function(g_star, criterion_name) {
    ...
    # Locate g_star within gammas_positive and get its neighbors
